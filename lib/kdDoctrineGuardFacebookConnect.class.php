...
//        kdDoctrineGuardFacebookConnectFilter::log($me['id']);
//        kdDoctrineGuardFacebookConnectFilter::log("user " . $sfGuardUser);
//        kdDoctrineGuardFacebookConnectFilter::log('kdDoctrineGuardFacebookConnect::updateOrdCreateUsers::48');
        ...
        //$sfGuardUser->setUid(SecurityUtil::generateUuid());
//        kdDoctrineGuardFacebookConnectFilter::log('end of update/create');
        $sfGuardUser->setDob(DateUtil::mysqlTime(strtotime($me['birthday'])));
        if($sfGuardUser->hasGroup(sfGuardGroup::CUSTOMER) === false) {
            $sfGuardUser->addGroupByName(sfGuardGroup::CUSTOMER);
        }
        $sfGuardUser->save();
